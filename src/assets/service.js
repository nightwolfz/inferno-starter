...
var precacheConfig = [["/","d41d8cd98f00b204e9800998ecf8427e"],["/build/bundle-966181ca.js","0dc865702071c4632d446332f9097be9"],["/build/bundle-c854dc3b.css","f112db08681bd745bab7478eabf13b48"]];
var cacheName = 'sw-precache-v2-inferno-starter-cache-' + (self.registration ? self.registration.scope : '');
...
self.addEventListener('fetch', function(event) {
  if (event.request.method === 'GET') {
    ...
    if (!shouldRespond &&
        ...
        isPathWhitelisted(["^\\/page\\/"], event.request.url)) {
...
toolbox.router.get(/^http:\/\/localhost:2000\/api/, toolbox.networkFirst, {});
